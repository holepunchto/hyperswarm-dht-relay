...
class Node extends EventEmitter {
  ...
  connect (remotePublicKey, options = {}) {
    ...
    const handshake = new Handshake(this._protocol, alias, true, keyPair, remotePublicKey)
...
function onNoiseSend (message) {
  ...
  if (socket) {
    ...
    socket._handshake._onNoiseSend(message)
  }
}
...
function onNoiseReceive (message) {
  ...
  if (socket) {
    socket._handshake._onNoiseReceive(message)
  }
}
