...
class ServerProxy extends EventEmitter {
  constructor (node, socket, protocol, alias, remoteAlias, keyPair) {
    ...
    this._server = node._dht.createServer({
      firewall: custodial ? this._firewall.deny : null,
      createHandshake: custodial ? null : createHandshake.bind(this),
      createSecretStream: custodial ? null : createSecretStream.bind(this)
    })
