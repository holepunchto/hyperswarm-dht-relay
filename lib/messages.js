...
const result = message(15, 'result', {
  preencode (state, m) {
...
const finished = message(16, 'finished', query)

const lookup = message(17, 'lookup', {
  preencode (state, m) {
    query.preencode(state, m)
...
const announce = message(18, 'announce', {
  preencode (state, m) {
    state.end++ // Flags
    query.preencode(state, m)
    topic.preencode(state, m.topic)
...
const unannounce = message(19, 'unannounce', announce)
...
const signAnnounce = message(20, 'signAnnounce', {
  preencode (state, m) {
    id.preencode(state, m.id)
...
const signUnannounce = message(21, 'signUnannounce', signAnnounce)

const signature = message(22, 'signature', {
  preencode (state, m) {
    id.preencode(state, m.id)
...
const noiseSend = message(23, 'noiseSend', {
  preencode (state, m) {
    state.end++ // Flags
    id.preencode(state, m.id)
...
const noiseReceive = message(24, 'noiseReceive', {
  preencode (state, m) {
    state.end++ // Flags
    id.preencode(state, m.id)
...
const noiseReply = message(25, 'noiseReply', {
  preencode (state, m) {
    state.end++ // Flags
    id.preencode(state, m.id)
    buffer.preencode(state, m.payload)
