...
function encodingFor (type) {
  switch (type) {
    ...
    case m.accept.type: return m.destroy
    ...
    case m.noiseSend.type: return m.noiseRequest
    case m.noiseReceive.type: return m.noiseRequest
    case m.noiseReply.type: return m.noiseResponse
    default: return null
  }
}
